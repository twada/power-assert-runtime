...
Decorator.prototype.decorated = function () {
    ...
    if (typeof this.receiver === 'function') {
        ...
        if (candidates.length === 1) {
            ...
            enhancement = decorate(this, this.receiver, numberOfArgumentsToCapture(functionMatcher));
        }
    }
    this.matchers.forEach(function (matcher) {
        ...
        if (methodName && typeof that.receiver[methodName] === 'function') {
            ...
            enhancement[methodName] = decorate(that, baseAssert, numNonMessageArgs, that.receiver);
        }
    });
