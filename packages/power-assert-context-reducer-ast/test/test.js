...
var AstReducer = require('..');
var estraverse = require('estraverse');
var assert = require('assert');

describe('AstReducer', function () {

    it('add `ast`, `tokens` and `visitorKeys` to powerAssertContext', function () {
        var context = {
            source: {
    ...
    it('parse embedded JSON if exists', function () {
        var alreadyParsed = {
            source: {
                content: 'assert(foo === bar)',
                filepath: 'test/some_test.js',
